...
{
    init_pin_table();
    char address[ADDRESS_PIN+1];//input address
    char data[IO_PINS+1];//input data
    char write_data[IO_PINS+1];//Store original data
    char write_address[ADDRESS_PIN+1];//Store original address
